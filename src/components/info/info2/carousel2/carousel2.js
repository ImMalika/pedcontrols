    ...
    <Carousel className="carousel2">
      <div>
        <img
          ...
          alt=""
        />
        <Link to="/study" className="link">Modulli dastur 1</Link>
      </div>
      <div>
        <img
          ...
          alt=""
        />
        <Link to="/study" className="link">Modulli dastur 2</Link>
      </div>
      <div>
        <img
          ...
          alt=""
        />
        <Link to="/study" className="link">Modulli dastur 3</Link>
      </div>
    </Carousel>
  );
};
